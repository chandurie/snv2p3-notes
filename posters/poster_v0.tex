...
\definecolor{columnblue}{HTML}{E4F1FB}
\definecolor{datasetgreen}{HTML}{0B8043}
\definecolor{codegreen}{HTML}{34A853}
\definecolor{codeblue}{HTML}{1A73E8}
\definecolor{codepurple}{HTML}{9334E6}
\definecolor{codeorange}{HTML}{F29900}
\definecolor{codered}{HTML}{E53935}
\definecolor{codegray}{HTML}{5F6368}
\definecolor{codecomment}{HTML}{0F9D58}
\definecolor{codestring}{HTML}{D81B60}
...
\newcommand{\datasetbox}[2]{%
  \tcbox[colframe=#2,colback=#2!12!white,boxrule=0.6pt,arc=2mm,left=4mm,right=4mm,top=1mm,bottom=1mm]{\textbf{#1}}%
}
...
\newenvironment{tightblock}[1]{%
  \begin{block}{#1}\vspace{0.6em}
}{\vspace{0.6em}\end{block}}
...
Augustin Stark & 1813--1835 & Normalizing tabular layouts; linking weather annotations to group counts. \\
...
\begin{itemize}
  ...
  \item Zürich pipeline combines Transkribus extraction with manual review to reach the 2025 target.
...
\begin{tightblock}{Connect with SILSO}
\centering
\includegraphics[width=0.62\linewidth]{./figures/qr-silso.png}\\[0.6em]
