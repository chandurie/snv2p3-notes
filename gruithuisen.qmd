...
#### Importance (for FARSuN & S<sub>N</sub> V3)
...
- Includes both spotless and active days — essential for long-term continuity and low-activity baselines in the Sunspot Number (S<sub>N</sub> V3).
...
### Next Steps (toward S<sub>N</sub> V3 integration)
...
Gruithuisen’s manuscripts offer a long, context-rich, early-19th-century record of solar and meteorological activity. With extraction, QC nearly complete, this dataset is poised to become a cornerstone for S<sub>N</sub> V3 calibration and uncertainty modeling within the FARSuN project.
