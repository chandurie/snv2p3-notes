...
fig = observer_bubble_plots_force_start_year_new3(observer_stats_all_combined)

fig

```

<!-- ![](./figures/Observer_bubble_plots.png){fig-align="center" width=80%} -->
