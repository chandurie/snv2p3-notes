...
%      \callout{Release goal}{SN V3.0 with open uncertainties}
    \end{minipage}
    \vspace{0.3cm}
  \end{beamercolorbox}%
...
\begin{tightblock}{FARSuN Historical Sunspot Database} % — Status \& Outlook}
  ...
  \begin{itemize}
    ...
    \item Use this harmonized database as the foundation for SN V3.0 calibration and long-term solar activity studies.
  \end{itemize}
...
% They are now fully digitized and integrated in FARSuN, providing four centuries of observer statistics and forming a key component of the historical foundation needed for the ongoing reconstruction of SN V3.0.
%
% % \textbf{Current focus}
\begin{itemize}
...
% %   \item Deliver public access to the curated Z\"urich dataset to support reconstruction of SN~V3.0.
% % \end{itemize}
%   \centering
...
\vspace{0.3em}
The Gruithuisen manuscripts (1817--1849) capture daily sunspot notes, drawings, and weather context in German Kurrent script, supplying early-19th-century coverage vital for SN~V3.0 refinement.
...
%   \item Publish FAIR, VO-ready daily tables and image catalogues via ROB/SILSO to support SN~V3.0 calibration and uncertainty modelling.
% \end{itemize}
\begin{figure}[t]
  \centering
...
\begin{tightblock}{From Raw to SN V3.0}
\begin{enumerate}
...
\end{minipage}\hfill
\begin{minipage}[t]{0.48\linewidth}
  \callout{\color{codeblue}Forecasting}{Bias-free SN~V3.0 improves solar cycle prediction skill and operational space weather baselines.}
\end{minipage}
\par\vspace{0.25em}
\begin{minipage}[t]{0.48\linewidth}
...
%   \item Publish SN~V3.0 release notes covering uncertainties and API endpoints.
